...
public final class SkillRegistry {
    ...
    static {
        ...
        REGISTRY.put(SkillType.DIG_TO_SURFACE,
                ai.minecivilization.skills.impl.SurfaceEscapeSkill::new);
        REGISTRY.put(SkillType.PICKUP_ITEM, PickupItemSkill::new);
        REGISTRY.put(SkillType.PLACE_BLOCK, PlaceBlockSkill::new);
        REGISTRY.put(SkillType.PLACE_SIGN,
                ai.minecivilization.skills.impl.PlaceSignSkill::new);
        ...
        REGISTRY.put(SkillType.EXPLORE,
                ai.minecivilization.skills.impl.ExploreSkill::new);
